...
//   //     });
//   //     if (response.ok) {
//   //       onDelete(property._id); // Remove the deleted property from the list
//   //     } else {
//   //       alert('Failed to delete property.');
//   //     }
//   //   } catch (error) {
...
//                 Yes
//               </button> */}
//               <button className="bg-red-500 text-white py-1 px-3 rounded-md" onClick={() => handleDeleteConfirm(property._id)}>
//         Delete Property
//       </button>
//             </div>
//           </div>
